...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-qqman-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8016&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-qqman-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-qqman` can be installed with:

```
conda install r-qqman
```

It is possible to list all of the versions of `r-qqman` available on your platform with:
